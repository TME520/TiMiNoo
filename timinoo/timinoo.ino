...
#define comframev3_width 128
#define comframev3_height 64
static unsigned char comframev3_bits[] U8G_PROGMEM = {
  ...
  do {
    switch (gameMode) {
      case 0:
        // Idling
        // Icon frame
        u8g.drawXBMP(0, 0, comframev3_width, comframev3_height, comframev3_bits);
        switch (idlingStep) {
          case 1:
            catX = 8;
            catY = 8;
