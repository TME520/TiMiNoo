...
#define cat_sitting_003_width 12
#define cat_sitting_003_height 12
static unsigned char cat_sitting_003_bits[] U8G_PROGMEM = {
   0x60, 0x0c, 0xa0, 0x0b, 0x20, 0x08, 0xa0, 0x0c, 0x20, 0x08, 0x20, 0x08,
   0x10, 0x04, 0x10, 0x04, 0x1e, 0x04, 0x89, 0x0a, 0x8f, 0x0a, 0xf8, 0x0f };
...
void draw(int frameId, const char* text, int posx, int posy) {
  ...
  if ( frameId == 0 ) {
    u8g.drawXBMP(0, 0, cat_sitting_upscaled4x_001_width, cat_sitting_upscaled4x_001_height, cat_sitting_upscaled4x_001_bits);
  } else if ( frameId == 1 ) {
    u8g.drawXBMP(0, 0, cat_sitting_upscaled4x_002_width, cat_sitting_upscaled4x_002_height, cat_sitting_upscaled4x_002_bits);
  } else if ( frameId == 2 ) {
    u8g.drawXBMP(0, 0, cat_sitting_upscaled4x_003_width, cat_sitting_upscaled4x_003_height, cat_sitting_upscaled4x_003_bits);
  }
}
